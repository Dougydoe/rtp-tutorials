...
import { TextField, Label, Icon, Callout, DirectionalHint } from 'office-ui-fabric-react';
import styles from './FieldStyles.module.scss';
import "./Callout.css";

export interface ITextBoxFieldCalloutState {
    isCalloutVisible:boolean;
}

export class TextBoxFieldCallout extends React.Component<ITextBoxFieldProps, ITextBoxFieldCalloutState> {     
    ...
    public render(): React.ReactElement<ITextBoxFieldProps> {                   
        ...
        if (!fieldHidden) {
            fieldToDisplay = 
            <div>
                <div className={styles.row} ref={this._target}>
